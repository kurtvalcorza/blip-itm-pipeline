...
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/blip_itm_train.jsonl",
    "outputs/blip_itm_input_manifest.json",
    "outputs/blip_itm_evaluation_report.json",
    "outputs/blip_itm_scores.csv",
    "outputs/blip_itm_adapter",
    "outputs/blip_itm_result.json",
)
CODE_MARKERS = (
    # Stage 4: pinned captions + pinned photographs from two row groups, image-disjoint split + gallery, validation, JSONL, refusal probes
    "USE_BYOD = False",
    ...
    # Stage 6: two baselines and the frozen model over the gallery, per category
...
MARKDOWN_MARKERS = (
    "**Capability:** image-text matching / retrieval and bounded supervised fine-tuning",
    "**BSD-3-Clause**",
    "**Neither score is calibrated and neither abstains**",
    "**adaptation with matching captions**",
    "**CC BY 4.0**",
    "**first two row groups**",
    "**test gallery**",
    "**non-neural baselines**",
    "**chance**",
    "**colour-keyword nearest neighbour**",
    "**recall@1/5/10**",
    "**ITM pair accuracy**",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    77_202_384: "BLIP ITM fine-tune adapter.safetensors, 2 blocks, from the tutorial run",
    392_245_504: "mm-eval/VizWiz-Captions data/val-00004-of-00005.parquet at c4a6d89",
    895_599_664: "upstream tf_model.h5 of Salesforce/blip-itm-base-coco at bed8ad3 (not loaded)",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "4492465a41d32b3c12b8b7b6a0cf7e0a0e202a5b825b006ca0c85dcdf24efd3e": "mm-eval/VizWiz-Captions data/val-00004-of-00005.parquet at c4a6d89",
    "735c126984ca09ef7d7195730381de5ea24e5b5815810f8b0da9a7476c1728e3": "upstream tf_model.h5 of Salesforce/blip-itm-base-coco at bed8ad3 (not loaded)",
    "9799ebb13cf6a7e7c76afdd180892e21499ecefff697212ce4e505c7fc207d6e": "decoded-text digest of the 1,550 VizWiz-Captions tutorial rows",
}
